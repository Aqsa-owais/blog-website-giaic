      ...
      <section className="container px-4 py-10 mx-auto lg:h-128 lg:space-x-8 lg:flex lg:items-center">
        <div className="w-full text-center lg:text-left lg:w-1/2 lg:-mt-8">
          <h1 className="text-3xl leading-snug text-gray-800 dark:text-gray-200 md:text-4xl">
            Welcome to <span className="font-semibold">Aqsa Blog</span> for
          ...
          <p className="mt-4 text-lg text-gray-500 dark:text-gray-300">
            {`Discover insightful articles on programming languages like C and C++, as well as the latest advancements in AI technologies such as GPT and Gemini. Whether you're a beginner or an enthusiast, this blog is your go-to resource for learning and staying updated in the tech world.`}
          </p>
